...
public class GestureManager : MonoBehaviour
{
    ...
    private void CheckSingleFingerGesture(Touch finger, GestureInputProperties property)
    {
        ...
        else if (finger.phase == TouchPhase.Moved && property.startPoint.x != -1 && property.startPoint.y != -1)
        {
            property.endPoint = finger.position;

            if (property.gestureTime <= _swipeProperty.swipeTime &&
    ...
    public void OnEnableInputs(bool flag)
    {
        isEnabled = flag;
    }
}
