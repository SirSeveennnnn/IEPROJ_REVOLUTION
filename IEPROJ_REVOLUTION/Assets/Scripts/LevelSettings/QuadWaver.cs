...
public class QuadWaver : MonoBehaviour
{
    ...
    public float amplitudeX = 1.0f; // Controls the distance of the wave in the Z direction.
    ...
    void Update()
    {
        ...
        float newZ = originalPosition.z + Mathf.Sin(Time.time * speed * 0.5f) * amplitudeZ; // Adjust the factor for Z motion.
        float newX = originalPosition.x + Mathf.Sin(Time.time * speed * 0.5f) * amplitudeX; // Adjust the factor for Z motion.
